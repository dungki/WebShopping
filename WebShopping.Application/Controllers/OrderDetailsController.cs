...
namespace WebShopping.Application.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Quantity,UnitPrice,OrderId,ProductId")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Quantity,UnitPrice,OrderId,ProductId")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
